...
// @updateURL    https://rawgit.com/soscripted/sox/repo-system/sox.user.js
...
// @require      https://rawgit.com/soscripted/sox/repo-system/sox.enhanced_editor.js?v=1.0.2a
...
(function (sox, $, undefined) {
    ...
    (function () {
        ...
        $('head').append('<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">')
            .append('<link rel="stylesheet" type="text/css" href="https://rawgit.com/soscripted/sox/repo-system/sox.css?v=1.0.2a" />');
