...
2. Install the script. Clicking on 'install' below will make Tampermonkey prompt you automatically to install it.
    ...
    - Official Version: <kbd>[install](https://github.com/soscripted/sox/raw/v2.9.0/sox.user.js)</kbd>. <kbd>[view source](https://github.com/soscripted/sox/blob/v2.9.0/sox.user.js)</kbd>
